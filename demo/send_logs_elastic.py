...
def send_log():
    try:
        ...
        sock.settimeout(5) 
        option = int(input("Press 1, 2, 3, or 4 to send corresponding log message: "))
        ...
        if option == 1:
            ...
            payload = firewall_read_log
        elif option == 4:
            payload = telegram_proxy_log
        else:
