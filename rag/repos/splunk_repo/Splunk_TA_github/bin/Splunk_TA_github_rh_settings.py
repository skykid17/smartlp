...
from Splunk_TA_github_rh_proxy_validation import ProxyValidation, ProxyURLValidation
import logging
...
class GitHubExternalHandler(AdminExternalHandler):
    def __init__(self, *args, **kwargs):
        log_filename = "Splunk_TA_github_settings"
    ...
    def handleEdit(self, confInfo):
        ...
        """
        if self.payload.get("proxy_url") and ProxyURLValidation().is_ipv6(
