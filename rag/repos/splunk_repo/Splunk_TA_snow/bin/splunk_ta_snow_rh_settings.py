...
from splunk_ta_snow_account_validation import (
    LogLevelValidation,
    ProxyTypeValidation,
    ProxyURLValidation,
    ProxyValidation,
...
class SettingsHandler(AdminExternalHandler):
    ...
    def __init__(self, *args, **kwargs):
        log_filename = "splunk_ta_snow_settings"
        self.logger = create_log_object(log_filename)
