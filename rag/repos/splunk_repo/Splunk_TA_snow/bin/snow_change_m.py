...
class ManualSnowChange(st.SnowTicket):
    ...
    def _get_events(self):
        (
            ...
            create_parser,
            update_parser,
        ) = self._create_arg_parsers()  # pylint: disable=E1101
        ...
        create_parser.add_argument(
            ...
            action="store",
            default="",
            help="Person primarily responsible for" "working this task",
        )
        create_parser.add_argument(
            "--start_date",
            dest="start_date",
            ...
            action="store",
            default="",
            help="Planned start date of this change in " '"YYYY-MM-DD hh:mm:ss" format',
        )
        create_parser.add_argument(
            "--end_date",
            dest="end_date",
            ...
            action="store",
            default="",
            help="Planned end date of this change in " '"YYYY-MM-DD hh:mm:ss" format',
        )
        create_parser.add_argument(
            "--requested_by",
            dest="requested_by",
