...
from hydra_inframon.hydra_worker import HydraWorker


class TAVMwareHydraWorker(HydraWorker):
	title = "TA-vmware-inframon Hydra Worker"
	description = "Worker to perform VMware vSphere collection tasks."
	handlers = {
				"hostvmperf" : performance_handlers.HostVMPerfHandler,
				"clusterperf" : performance_handlers.ClusterPerfHandler,
				"vcperf" : performance_handlers.VcenterPerfHandler,
				"datastoreperf" : performance_handlers.DatastorePerfHandler,
