...
/******/ 	return __webpack_require__(__webpack_require__.s = "./package/src/components/pages/analytics_advisor.js");
/******/ })
/************************************************************************/
/******/ ({
...
defineJQueryPlugin(tooltip_Tooltip)
...
/***/ "./package/src/components/pages/analytics_advisor.js":
/***/ (function(module, exports, __webpack_require__) {

"use strict";


var _sliceInstanceProperty = __webpack_require__("./node_modules/@babel/runtime-corejs3/core-js-stable/instance/slice.js");
var _Array$from = __webpack_require__("./node_modules/@babel/runtime-corejs3/core-js-stable/array/from.js");
var _Symbol = __webpack_require__("./node_modules/@babel/runtime-corejs3/core-js-stable/symbol.js");
var _getIteratorMethod = __webpack_require__("./node_modules/@babel/runtime-corejs3/core-js/get-iterator-method.js");
var _Array$isArray = __webpack_require__("./node_modules/@babel/runtime-corejs3/core-js-stable/array/is-array.js");
var _interopRequireDefault = __webpack_require__("./node_modules/@babel/runtime-corejs3/helpers/interopRequireDefault.js");
var _includes = _interopRequireDefault(__webpack_require__("./node_modules/@babel/runtime-corejs3/core-js-stable/instance/includes.js"));
var _parseInt2 = _interopRequireDefault(__webpack_require__("./node_modules/@babel/runtime-corejs3/core-js-stable/parse-int.js"));
...
var _concat = _interopRequireDefault(__webpack_require__("./node_modules/@babel/runtime-corejs3/core-js-stable/instance/concat.js"));
var _typeof2 = _interopRequireDefault(__webpack_require__("./node_modules/@babel/runtime-corejs3/helpers/typeof.js"));
 ...
 */
require(['splunkjs/mvc', 'splunkjs/mvc/tableview', 'splunkjs/mvc/simpleform/input/dropdown', 'splunkjs/mvc/searchmanager', 'splunkjs/mvc/simplexml/ready!'], function (mvc, TableView, DropdownInput, SearchManager) {
  Promise.resolve(/* AMD require */).then(function() { /* WEBPACK VAR INJECTION */(function($) {var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("./node_modules/bootstrap/js/src/tooltip.js")]; (function () {
      ...
      render: function render($td, cell) {
        ...
        if (cell.field === 'Data Availability') {
          if (cellvalue === 'Available') {
            cellvalue = cellvalue.replace(RegExp("Available", "gi"), '<span class="green">Available</span>');
          }
          if (cellvalue === 'Unavailable') {
            cellvalue = cellvalue.replace(RegExp("Unavailable", "gi"), '<span class="red">Unavailable</span>');
          }
        }
        $td.html(cellvalue);
      }
    ...
    /**
    * The below is the dropdown and submit button for bookmark selection
    */
    if ((0, _typeof2["default"])(splunkjs.mvc.Components.getInstance("dropdownListSearch")) == "object") {
      splunkjs.mvc.Components.revokeInstance("dropdownListSearch");
    }
    var dropdownListSearch = new SearchManager({
      "id": "listBookmarks",
      "sample_ratio": null,
      "latest_time": "now",
      "search": "| inputlookup bookmark_names | fields name referenceName | streamstats count AS order | eval order=order+1 | append [ | makeresults count=1 | eval name=\"Bookmarked\", referenceName=\"bookmarked\", order=1 ] | append [ | makeresults count=1 | eval name=\"Successfully Implemented\", referenceName=\"successfullyImplemented\", order=6 ] | sort order | fields - _time | fields name referenceName",
      "earliest_time": "-1h",
      "cancelOnUnload": true,
      "status_buckets": 0,
    ...
    dropdownListSearch.on("search:done", function () {
      //validateCurrent();
    });
    if ((0, _typeof2["default"])(splunkjs.mvc.Components.getInstance("bookmarkSelectionDropdown")) == "object") {
      splunkjs.mvc.Components.revokeInstance("bookmarkSelectionDropdown");
    }
    var bookmarkSelectionDropdown = new DropdownInput({
      "id": "bookmarkSelectionDropdown",
      "choices": [],
      "valueField": "referenceName",
      "showClearButton": false,
      "labelField": "name",
      "searchWhenChanged": false,
      "selectFirstChoice": true,
      "value": "$form.referenceName$",
      "managerid": "listBookmarks",
      "el": $('#bookmarkSelectionDropdownWrapper')
    }, {
      tokens: true
    }).render();
    $('#bookmarkSelectionTextbox').append("<textarea id=\"bookmark_notes\" rows=\"5\" cols=\"20\" onkeyup='this.value = this.value.replace(/[\"]/g,\"\")'></textarea>");
    $('#bookmark_notes').val("Bookmarked from Analytics Advisor " + new Date().toUTCString());
    $('#bookmarkSelectionButton').append($('<button>').attr({
      type: 'button'
    }).addClass('btn').text('Add Bookmarks').on('click', function () {
      $(".bookmarkSelectionProgress").addClass("button-spinner spinner-border");
      var content_search = splunkjs.mvc.Components.getInstance(splunkjs.mvc.Components.attributes.content_table.options.managerid);
      var content_results = content_search.data("results"); // get the data from that search
      content_results.on("data", function () {
        var _content_results$data;
        var content_resultsArray = content_results === null || content_results === void 0 || (_content_results$data = content_results.data()) === null || _content_results$data === void 0 ? void 0 : _content_results$data.rows;
        //console.log("content_resultsArray",content_resultsArray)
        var bookmarks = [];
        var bookmarkStatus = defaultTokenModel.get("form.referenceName");
        var bookmarkNotes = $('#bookmark_notes').val();
        var _iterator = _createForOfIteratorHelper(content_resultsArray),
          _step;
        try {
          for (_iterator.s(); !(_step = _iterator.n()).done;) {
            ...
            var bookmark = {};
            var showcaseId = c[16];
            var showcaseName = c[0];
            var oldBookmarkStatus = c[11];
            bookmark["showcaseId"] = showcaseId;
            bookmark["showcaseName"] = showcaseName;
            bookmark["oldBookmarkStatus"] = oldBookmarkStatus;
            bookmark["bookmarkStatus"] = bookmarkStatus;
            bookmark["bookmarkNotes"] = bookmarkNotes;
            bookmarks.push(bookmark);
            setbookmark_status(showcaseName, showcaseId, bookmarkStatus, null, bookmarkNotes);
          }
        } catch (err) {
          _iterator.e(err);
        } finally {
        ...
        $(".bookmarkSelectionProgress").removeClass("button-spinner spinner-border");
    ...
    */
    var $Wrapper_Div_Mitre = $('<div />').attr({
      "class": 'wrapper_class'
    });
    var $Table_Legend_Container = $('<div />').attr({
      "class": 'mitremaptable_legend'
    });
    // Access the "default" token model
    var mitreAttackVersion = window.localStorage["sse-mitreattack-version"] || "17.1";
    var $Mitre_Attack_Version = $("<div />").attr({
      "class": "sub_class"
    }).append('ATT&amp;CK version:&nbsp;' + mitreAttackVersion + '&nbsp;&nbsp;');
    var defaultTokenModel = mvc.Components.get("default");
    var colorbyToken = defaultTokenModel.get("colorby");
    defaultTokenModel.on("change:form.colorby", function (model, value) {
      $(".mitremaptable_legend").empty();
      colorbyToken = value;
    });
    defaultTokenModel.on("change:form.threat_group", function (model, value) {
      $(".mitremaptable_legend").empty();
    });
    defaultTokenModel.on("change:form.software", function (model, value) {
      $(".mitremaptable_legend").empty();
    });
    defaultTokenModel.on("change:form.datasource_selection", function (model, value) {
      $(".mitremaptable_legend").empty();
    });
    var MitreMapTableRenderer = TableView.BaseCellRenderer.extend({
      ...
      render: function render($td, cell) {
        var cellvalue = cell.value;
        colorbyToken = defaultTokenModel.get("form.colorby");
        $td.addClass("mitremaptablecell");
        if (cellvalue != null) {
          ...
          var NeedsData = obj["Needs data"];
          var Total = obj["Total"];
          var Bookmarked = obj["Bookmarked"];
          var Selected = obj["Selected"];
          var Selected_Threat_Groups = "-";
          var TechniquePopularity = obj["Technique Popularity"];
          var Threat_Group_Circles_Container = "";
          var FirstColor = hexToRgb(Color);
          var SecondColor = hexToRgb(Color);
          var FirstOpacity = Math.min(Opacity, 0.6);
          var SecondOpacity = Math.min(Opacity, 0.6);
          var ThreatGroupColor = hexToRgb("#982a39");
          var GradientFillPercentage = "50%";
          var ContentTokenValues = ["Total", "Active", "Available", "Needs data"];
          if ($(".mitremaptable_legend .content_legend_box")[0] == undefined) {
            var legendtitle = "";
            if ((0, _includes["default"])(ContentTokenValues).call(ContentTokenValues, colorbyToken)) {
              legendtitle = "Content (" + colorbyToken + ")";
            } else {
              legendtitle = colorbyToken;
            }
            $Table_Legend_Container.append($("<div />").attr({
              "class": "mitremaptable_legend_item"
            }).append('<div><i class="content_legend_box"></i> Content (Total)</div></div>'));
          }
          if (typeof obj["Selected_Threat_Groups"] != "undefined" && obj["Selected_Threat_Groups"] != "-") {
            Selected_Threat_Groups = obj["Selected_Threat_Groups"].split(",");
          }
          if (typeof obj["Groups"] != "undefined") {
            var Groups = obj["Groups"].split(",");
          }
          if (typeof obj["Software"] != "undefined") {
            var Software = obj["Software"].split(",");
          }
          var tooltip = "<h3>" + TechniqueId + "</h3>";
          tooltip += "<p>" + Technique + "</p>";
          tooltip += "<h4>Content</h4>";
          tooltip += "<div class=divTable>";
          tooltip += "<div class=divTableRow><div class=divTableCell>Active:</div><div>" + Active + "</div></div>";
          tooltip += "<div class=divTableRow><div class=divTableCell>Available:</div><div>" + Available + "</div></div>";
          tooltip += "<div class=divTableRow><div class=divTableCell>Needs Data:</div><div>" + NeedsData + "</div></div>";
          tooltip += "<div class=divTableRow><div class=divTableCell>Total:</div><div>" + Total + "</div></div>";
          tooltip += "<div class=divTableRow><div class=divTableCell>Bookmarked:</div><div>" + Bookmarked + "</div></div>";
          if (typeof Selected != "undefined" && (0, _parseInt2["default"])(Selected) > 0) {
            tooltip += "<div class=divTableRow><div class=divTableCell>Selected Data Source:</div><div>" + Selected + "</div></div>";
            $td.addClass("selected");
            if ($(".mitremaptable_legend .selected_legend_box")[0] == undefined) {
              $Table_Legend_Container.append($('<div />').attr({
                "class": 'mitremaptable_legend_item'
              }).append("<i class='selected_legend_box' style='margin-bottom: -1px;height:9px;'></i> Highlighted Data Source"));
            }
          }
          tooltip += "</div>";
          tooltip += "</p>";
          if (typeof Groups != "undefined") {
            SecondColor = ThreatGroupColor;
            SecondOpacity = "0.7";
            GradientFillPercentage = Math.round(Math.min(50, 100 * (Groups.length / Math.max(Selected_Threat_Groups.length, 1))), 0) + "%";
            tooltip += "<h4>Threat Groups</span></h4>";
            tooltip += "<div class=divTable>";
            tooltip += "<div class=divTableRow><div class=divTableCell>Total:</div><div>" + TechniquePopularity + "</div></div>";
            tooltip += "<div class=divTableRow><div class=divTableCell>Selection:</div><div>" + Groups.length + "</div></div>";
            tooltip += "</div>";
            tooltip += "<p>" + Groups + "</p>";
            if (Groups.length > 0) {
              Threat_Group_Circles_Container = "<i class='group_circle group_circle_technique'>" + Groups.length + "</i>";
            }
            if ($(".mitremaptable_legend .group_legend_box")[0] == undefined) {
              $Table_Legend_Container.append($('<div />').attr({
                "class": 'mitremaptable_legend_item'
              }).append("<i class='group_legend_box'></i> Threat Group (in Technique)"));
              $Table_Legend_Container.append($('<div />').attr({
                "class": 'mitremaptable_legend_item'
              }).append("<i class='group_inside_legend_box'></i> Threat Group (in Sub-Technique)"));
            }
          } else {
            tooltip += "<h4>Threat Groups</h4>";
            tooltip += "<div class=divTable>";
            tooltip += "<div class=divTableRow><div class=divTableCell>Total:</div><div>" + TechniquePopularity + "</div></div>";
            tooltip += "</div>";
          }
          if (typeof Software != "undefined" && Software != "-") {
            var Selected_Software = obj["Selected_Software"].split(",");
            var All_Software = Software;
            Software = (0, _filter["default"])(All_Software).call(All_Software, function (item) {
              return (0, _includes["default"])(Selected_Software).call(Selected_Software, item);
            });
            if (Software != "" && Software != "-") {
              tooltip += "<h4>Software</h4>";
              tooltip += "<p>" + Software + "</p>";
              $td.addClass("software");
              if ($(".mitremaptable_legend .software_legend_box")[0] == undefined) {
                $Table_Legend_Container.append($('<div />').attr({
                  "class": 'mitremaptable_legend_item'
                }).append("<i class='software_legend_box' style='margin-bottom: -1px;height:9px;'></i> Software"));
              }
            }
          }
          ...
          $td.attr("style", "background-color: rgb(" + FirstColor + "," + FirstOpacity + ") !important;" + "background-image: linear-gradient(to top, rgba(" + SecondColor + "," + SecondOpacity + ") 0%,rgba(" + FirstColor + "," + FirstOpacity + ") " + GradientFillPercentage + ") !important;");
          ...
          if (HasSubTechnique) {
            ...
            var Total_SubTechnique_Threat_Groups = 0;
            var _loop = function _loop() {
                SubTechnique_tooltip = "";
                FirstColorSubTechnique = hexToRgb(Sub_Techniques[key]["Color"]);
                SecondColorSubTechnique = hexToRgb(Sub_Techniques[key]["Color"]);
                FirstOpacitySubTechnique = Sub_Techniques[key]["Opacity"];
                SecondOpacitySubTechnique = Sub_Techniques[key]["Opacity"];
                SubTechnique_tooltip = "<h3>" + Sub_Techniques[key]["Sub_TechniqueId"] + "</h3>";
                SubTechnique_tooltip += "<p>" + key + "</p>";
                SubTechnique_tooltip += "<h4>Content</h4>";
                SubTechnique_tooltip += "<div class=divTable>";
                SubTechnique_tooltip += "<div class=divTableRow><div class=divTableCell>Active:</div><div>" + Sub_Techniques[key]["Active"] + "</div></div>";
                SubTechnique_tooltip += "<div class=divTableRow><div class=divTableCell>Available:</div><div>" + Sub_Techniques[key]["Available"] + "</div></div>";
                SubTechnique_tooltip += "<div class=divTableRow><div class=divTableCell>Needs Data:</div><div>" + Sub_Techniques[key]["Needs Data"] + "</div></div>";
                SubTechnique_tooltip += "<div class=divTableRow><div class=divTableCell>Total:</div><div>" + Sub_Techniques[key]["Total"] + "</div></div>";
                SubTechnique_tooltip += "<div class=divTableRow><div class=divTableCell>Bookmarked:</div><div>" + Sub_Techniques[key]["Bookmarked"] + "</div></div>";
                SubTechnique_tooltip += "</div>";
                Threat_Group_Class = "";
                if (typeof Sub_Techniques[key]["Threat_Groups"] != "undefined" && Sub_Techniques[key]["Threat_Groups"] != "-") {
                  var All_Threat_Groups = Sub_Techniques[key]["Threat_Groups"].split(",");
                  var Threat_Groups = (0, _filter["default"])(All_Threat_Groups).call(All_Threat_Groups, function (item) {
                    return (0, _includes["default"])(Selected_Threat_Groups).call(Selected_Threat_Groups, item);
                  });
                  SecondColorSubTechnique = ThreatGroupColor;
                  SecondOpacitySubTechnique = "0.7";
                  GradientFillPercentage = Math.round(Math.min(50, 100 * (Threat_Groups.length / Math.max(Selected_Threat_Groups.length, 1))), 0) + "%";
                  Total_SubTechnique_Threat_Groups += Threat_Groups.length;
                  if (Threat_Groups.length > 1) {
                    Threat_Group_Class = "threat_group_multiple";
                    $td.addClass("threat_group_multiple");
                  } else {
                    Threat_Group_Class = "threat_group";
                  }
                  SubTechnique_tooltip += "<h4>Threat Groups</h4>";
                  SubTechnique_tooltip += "<div class=divTable>";
                  SubTechnique_tooltip += "<div class=divTableRow><div class=divTableCell>Total:</div><div>" + Sub_Techniques[key]["Sub-Technique Popularity"] + "</div></div>";
                  if (Threat_Groups.length > 0) {
                    SubTechnique_tooltip += "<div class=divTableRow><div class=divTableCell>Selection:</div><div>" + Threat_Groups.length + "</div></div>";
                    SubTechnique_tooltip += "</div>";
                    SubTechnique_tooltip += "<p>" + Threat_Groups + "</p>";
                ...
                Software_Class = "";
                if (typeof Sub_Techniques[key]["Software"] != "undefined" && Sub_Techniques[key]["Software"] != "-") {
                  var _Selected_Software = obj["Selected_Software"].split(",");
                  var _All_Software = Sub_Techniques[key]["Software"].split(",");
                  Software = (0, _filter["default"])(_All_Software).call(_All_Software, function (item) {
                    return (0, _includes["default"])(_Selected_Software).call(_Selected_Software, item);
                  });
                  Software_Class = "software";
                  SubTechnique_tooltip += "<h4>Software</h4>";
                  SubTechnique_tooltip += "<p>" + Software + "</p>";
                  $td.addClass(Software_Class);
                }
                Sub_Techniques_Container_Style = "background-color: rgb(" + FirstColorSubTechnique + "," + FirstOpacitySubTechnique + ") !important;" + "background-image: linear-gradient(to top, rgba(" + SecondColorSubTechnique + "," + SecondOpacitySubTechnique + ") 0%,rgba(" + FirstColorSubTechnique + "," + FirstOpacitySubTechnique + ") " + GradientFillPercentage + ") !important;";
                Sub_Techniques_Container += "<div class='subtechnique " + Threat_Group_Class + " " + Software_Class + "' style='" + Sub_Techniques_Container_Style + "'>";
                Sub_Techniques_Container += "<div  class='technique-cell' style='' data-bs-placement='right' title='" + SubTechnique_tooltip + "'>";
                Sub_Techniques_Container += key;
                Sub_Techniques_Container += "</div>";
                Sub_Techniques_Container += "</div>";
              },
              SubTechnique_tooltip,
              FirstColorSubTechnique,
              SecondColorSubTechnique,
              FirstOpacitySubTechnique,
              SecondOpacitySubTechnique,
              Threat_Group_Class,
              Software_Class,
              Sub_Techniques_Container_Style;
            for (var key in Sub_Techniques) {
              _loop();
            }
            //Add the Threat Group inside subtechnique counter circle
            if (Total_SubTechnique_Threat_Groups > 0) {
              Threat_Group_Circles_Container += "<i class='group_circle group_circle_subtechnique'>" + Total_SubTechnique_Threat_Groups + "</i>";
            }
            Sub_Techniques_Container += "</div>";
            if (Threat_Group_Circles_Container != "") {
              Threat_Group_Circles_Container = "<div class='group_circle_container'>" + Threat_Group_Circles_Container + "</div>";
            }
            $td.append('<div class="technique-container has_sub_technique">' + Threat_Group_Circles_Container + '<div class="technique" data-bs-toggle="tooltip" data-bs-placement="' + data_placement + '" title="' + tooltip + '">' + Technique + '</div>' + '<div class="subtechniques_expander" data-bs-toggle="tooltip" data-bs-placement="right" title="' + Sub_Techniques_Container + '"><span class="handle">=</span></div></div>');
          } else {
            if (Threat_Group_Circles_Container != "") {
              Threat_Group_Circles_Container = "<div class='group_circle_container'>" + Threat_Group_Circles_Container + "</div>";
            }
            $td.append('<div class="technique-container">' + Threat_Group_Circles_Container + '<div class="technique" data-bs-toggle="tooltip" data-bs-placement="' + data_placement + '" title="' + tooltip + '">' + Technique + '</div></div>');
          }
          (0, _find["default"])($td).call($td, ".technique").tooltip({
            trigger: 'hover',
            html: true,
            boundary: 'window',
            container: 'body'
          });
          (0, _find["default"])($td).call($td, ".technique").click(function (e) {
            // Overriding default drilldown token set.
            var defaultTokenModel = mvc.Components.get("default");
            var technique = $(this).text().replace("=", "");
            var techniqueId = $(this).attr("data-bs-original-title").match(/^<h3>([^<]*)/)[1];
            var technique_combined = techniqueId + " - " + technique;
            defaultTokenModel.set("form.MITRE_Technique2", technique_combined);
            defaultTokenModel.set("MITRE_Technique2", technique_combined);
          });
          (0, _find["default"])($td).call($td, ".subtechniques_expander").tooltip({
            trigger: 'click',
            html: true,
            boundary: 'window',
            container: (0, _find["default"])($td).call($td, ".subtechniques_expander"),
            sanitize: false,
            placement: 'right'
          }).click(function (e) {
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip-inner").css("padding", "0px 0px");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip-inner").css("margin", "5px");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip-inner").css("background-color", "#e1e6eb");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip.fade.show.bs-tooltip-end .tooltip-arrow").css("border-right-color", "#73D0FB");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip.fade.show.bs-tooltip-bottom .tooltip-arrow").css("border-bottom-color", "#73D0FB");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip.fade.show.bs-tooltip-start .tooltip-arrow").css("border-left-color", "#73D0FB");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip.fade.show.bs-tooltip-top .tooltip-arrow").css("border-top-color", "#73D0FB");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip-arrow").css("border-width", "5px");
            (0, _find["default"])($td).call($td, ".subtechniques_expander .tooltip-arrow").css("margin", "-6px");
          });
          (0, _find["default"])($td).call($td, ".subtechniques_expander").on('shown.bs.tooltip', function () {
            (0, _find["default"])($td).call($td, ".subtechniques .subtechnique .technique-cell").tooltip({
              html: true,
              trigger: 'hover',
              boundary: 'window',
              container: 'body'
            ...
            //This section moves down the tooltips for the table on the first rows so they are not hidden
            $("#mitremaptable tr[data-row-index=0] .subtechniques_expander + .tooltip .tooltip-inner").each(function (index) {
              var marginCalc = 0;
              if ($(this).children().children().length == 5) {
                marginCalc = 15;
              } else if ($(this).children().children().length == 6) {
                marginCalc = 28;
              } else if ($(this).children().children().length == 7) {
                marginCalc = 40;
              } else if ($(this).children().children().length == 8) {
                marginCalc = 80;
              } else if ($(this).children().children().length == 9) {
                marginCalc = 80;
              } else if ($(this).children().children().length > 9) {
                marginCalc = ($(this).children().children().length - 8) * 28 + 80;
              }
              $(this).css("margin-top", marginCalc + "px");
            });
            $("#mitremaptable tr[data-row-index=1] .subtechniques_expander + .tooltip .tooltip-inner").each(function (index) {
              var marginCalc = 0;
              if ($(this).children().children().length == 11) {
                marginCalc = 64;
              } else if ($(this).children().children().length > 11) {
                marginCalc = ($(this).children().children().length - 10) * 28 + 64;
              }
              $(this).css("margin-top", marginCalc + "px");
            });
            $("#mitremaptable tr[data-row-index=2] .subtechniques_expander + .tooltip .tooltip-inner").each(function (index) {
              var marginCalc = 0;
              if ($(this).children().children().length == 11) {
                marginCalc = 15;
              } else if ($(this).children().children().length > 11) {
                marginCalc = ($(this).children().children().length - 10) * 28 + 15;
              }
              $(this).css("margin-top", marginCalc + "px");
            });
          });
    ...
    if (mvc.Components.get('mitremaptable') || mvc.Components.get('mitremaptablev7')) {
      //MITRE Matrix with sub-techniques only works with v8 or higher. This is due to the eval mvmap command. 
      if ((0, _parseInt2["default"])(localStorage["splunk-major-version"]) >= 8) {
        mvc.Components.get('mitremaptable').getVisualization(function (tableView) {
          // Register custom cell renderer, the table will re-render automatically
          tableView.addCellRenderer(new MitreMapTableRenderer());
        });
        $($Wrapper_Div_Mitre).append($Table_Legend_Container);
        $($Wrapper_Div_Mitre).append($Mitre_Attack_Version);
        $("#mitremaptable h3").after($Wrapper_Div_Mitre);
      } else {
        mvc.Components.get('mitremaptablev7').getVisualization(function (tableView) {
          // Register custom cell renderer, the table will re-render automatically
          tableView.addCellRenderer(new MitreMapTableRenderer());
        });
      }
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__("./node_modules/jquery/dist/jquery.js")))}).catch(__webpack_require__.oe);
});

/**
 * The below defines tooltips.
 */
require(['jquery', 'splunkjs/mvc', "splunkjs/ready!"], function ($, mvc, Ready) {
  Promise.resolve(/* AMD require */).then(function() { var __WEBPACK_AMD_REQUIRE_ARRAY__ = [__webpack_require__("./node_modules/bootstrap/js/src/tooltip.js")]; (function () {
    $.prototype.tooltip = function (tooltip) {
      return function (config) {
        try {
          return tooltip.call(this, config);
    ...
    $("label:contains('Split by')").attr('title', 'This option selects which field to split the X-axis by.');
    $("label:contains('Phase')").attr('title', '<p>Current: Content is installed, the data is in Splunk and it is enabled.</p><p>Phase 1: Content is installed, the data is in Splunk and but it is disabled.</p><p>Phase 2: Content is installed, the data is not in Splunk and it is disabled.</p><p>Selected Sourcetypes: This highlight where the selected sourcetypes would map to what is on the X-axis. .</p>');
    $("label:contains('Status')").attr('title', '<p>Active: Content is enabled and the data required is available in Splunk.</p><p>Available: Content is disabled and the data required is available in Splunk.</p><p>Needs data: We need more data to enable the content</p><p>Selected: This highlights where the selected data sources would map to what is on the X-axis. .</p>');
    $("label:contains('Sourcetype origin')").attr('title', '<p>Installed Sourcetypes: The chart is filtered to Sourcetypes that are currently installed.</p><p>All Sourcetypes: The chart is filtered to sourcetypes that are either installed or are referred to in the content search string.</p><p>Sample Sourcetypes: The chart is filtered to sourcetypes that are provided with the app. This list represents a large proportion of the sourcetypes available on Splunkbase. This setting will allow you to run analytics without having any Add-ons or data in Splunk.</p>');
    $("label:contains('Sourcetype selection')").attr('title', 'Select which Sourcetypes to highlighted in the "Selected" field');
    $("label:contains('Data')").attr('title', 'Filters the list to show if we have data for the content.');
    $("label:contains('Enabled')").attr('title', 'Filters the list to show if we have enabled the content.');
    $("label:contains('Datamodel')").attr('title', 'Filters the list to show only the selected Datamodel.');
    $("label:contains('Originating app')").attr('title', 'Filters the list to show only content from a specific app.');
    $("label:contains('Content type')").attr('title', 'Filters the list to show only content that is based on either Indexed data or a Datamodel.');
    $("label:contains('Use Case')").attr('title', 'Filters the list to show only the selected Use Cases. The Use Cases are high level categories that are useful to gauge the level of maturity for the content.');
    $("label:contains('Sourcetype filter')").attr('title', 'Filters to show only content that is mapped to the selected Sourcetypes.');
    $("label:contains('Add-On')").attr('title', 'Filters the list to show only content that is mapped to the selected Add-On.');
    $("label:contains('Sourcetype and Add-On')").attr('title', 'Toggle to show the list of Sourcetypes and Add-Ons associated with the content.');
    $("label:contains('Featured')").attr('title', 'Featured searches are those that come recommended by Splunk\'s Security SMEs.');
    $("label:contains('Bookmarked')").attr('title', 'Toggle to show only content that is bookmarked');
    $("label:contains('Bookmark Status')").attr('title', 'Filters the list to show only content that has the selected Bookmark Status');
    $("label:contains('Bookmarked and Featured')").attr('title', 'Toggle to show only content that is only bookmarked or featured');
    $("label:contains('Data Source')").attr('title', 'The data sources that power the content. These are mapped to individual technologies.');
    $("label:contains('Highlight Data Source')").attr('title', 'Highlight which content uses the selected Data Sources. Data Sources are mapped to individual technologies. The cells that have detections that require the selected datasource will have a <span class=green>green</span> border. ');
    $("label:contains('Data Source Category')").attr('title', 'The data category that powers the content. A data category is granular and details which types of events are required to enable the content.');
    $("label:contains('Journey')").attr('title', 'This represents where the content sits in the Splunk Security Journey.');
    $("label:contains('Search Query')").attr('title', 'Toggle to show the actual SPL search for the content.');
    $("label:contains('Color by')").attr('title', '<p>Select how to color the cells in the matrix.<br /><ul><li>Total means all content regardless of status.</li><li>Active means content which is currently enabled in your environment.</li><li>Available means content which is available to start using with your data.</li><li>Needs Data means content you could use if you ingested more data into Splunk.</li></ul></p>');
    $("label:contains('Search Filter')").attr('title', 'The filter does a case insensitive text match. There are implied wildcards before and after the input string. You can also specify underscore ( _ ) characters for a single character match.');
    $("label:contains('MITRE Tactic')").attr('title', 'MITRE Tactics represent the "why" of an ATT&CK technique. It is the adversary’s tactical objective: the reason for performing an action. See the MITRE reference link at the top of the page for more details.');
    $("label:contains('MITRE Technique')").attr('title', 'MITRE Techniques represents “how” an adversary achieves a tactical objective by performing an action. See the MITRE reference link at the top of the page for more details.');
    $("label:contains('MITRE Threat Group')").attr('title', 'MITRE ATT&CK maps out the threat groups that are known to use particular techniques. This is of particular value for organizations who have a solid understanding of who their attackers are, and can build defenses specifically tied to those attacking groups.');
    $("label:contains('MITRE ATT&CK Tactic')").attr('title', 'MITRE Tactics represent the "why" of an ATT&CK technique. It is the adversary’s tactical objective: the reason for performing an action. See the MITRE reference link at the top of the page for more details.');
    $("label:contains('MITRE ATT&CK Technique')").attr('title', 'MITRE Techniques represents “how” an adversary achieves a tactical objective by performing an action. See the MITRE reference link at the top of the page for more details.');
    $("label:contains('MITRE ATT&CK Software')").attr('title', 'Software is a generic term for custom or commercial code, operating system utilities, open-source software, or other tools used to conduct behavior modeled in ATT&CK. Software in ATT&CK come in two types, tools and malware. The cells that have detections that are linked to the Software will have an <span class=orange>orange</span> border. ');
    $("label:contains('MITRE ATT&CK Threat Group')").attr('title', 'MITRE ATT&CK maps out the threat groups that are known to use particular techniques. This is of particular value for organizations who have a solid understanding of who their attackers are, and can build defenses specifically tied to those attacking groups.');
    $("label:contains('Threat Group Count Filter')").attr('title', 'Filter the content based on how many Threat Groups are known to be using that Technique. This helps you prioritize content that helps with particularly popular Techniques.');
    $("label:contains('Filter')").attr('title', '<p>This dropdown allows you to filter the MITRE ATT&CK Matrix to only show cells that match the criteria.<br /><ul><li>Threat Group Count - Only show cells where there are at least 3 Threat Groups that have been known to have used the Technique. </li><li>Techniques with Content - Only show cells for which we have content, i.e. exclude all 0s.</li><li>Bookmarked Content - Only show cells that are linked to content that is bookmarked.</li><li>Threat Group Selection - Only show cells that are linked to the Threat Groups selected in the multi-select dropdown MITRE ATT&CK Threat Group</li></ul></p>');
    $("label:contains('Show Only Available Content')").attr('title', 'This checkbox filters out the MITRE ATT&CK Techniques that do not have an associated detection in this Splunk environment, i.e. it removes all cells with zeros.');
    $("label:contains('Show Only Popular Techniques')").attr('title', 'MITRE ATT&CK maps out the threat groups that are known to use particular techniques. This checkbox filters out the MITRE Techniques that are not very popular, i.e. less than 5 Threat Groups are known to be using them.');
    $("label:contains('MITRE ATT&CK Matrix Platform')").attr('title', 'The MITRE ATT&CK Enterprise Matrix contains multiple platforms. Use this selector to filter the MITRE ATT&CK Techniques to specific platforms.');
    $("label:contains('Kill Chain Phase')").attr('title', 'Each step in the Cyber Kill Chain defines the steps used by cyber attackers.  The theory is that by understanding each of these stages, defenders can better identify and stop attacks at each of the stages. See the Cyber Kill Chain reference link at the top of the page for more details.');
    $("label:contains('NIST')").attr('title', 'The NIST Cybersecurity Framework presents a listing of Functions, Categories, Subcategories and Informative References (standards, guidelines, and practices) that describe specific cybersecurity activities. The mapping in this app represents the Function and Category elements of the framework. See the NIST Cybersecurity Framework reference link at the top of the page for more details.');
    $("label:contains('CIS')").attr('title', 'The CIS Controls are a prioritized set of controls and actions to defend against pervasive cyber threats. See the CIS Controls reference link at the top of the page for more details.');
    $("label[title]").tooltip({
      html: true
    });
    $("#row1_col5 .panel-title:contains('Stage 1')").attr('title', '<h3>Collection</h3><p>Collect basic security logs and other machine data from your environment.</p>');
    $("#row1_col5 .panel-title:contains('Stage 2')").attr('title', '<h3>Normalization</h3><p>Apply a standard security taxonomy and add asset and identity data.</p>');
    $("#row1_col5 .panel-title:contains('Stage 3')").attr('title', '<h3>Expansion</h3><p>Collect additional high fidelity data sources like endpoint activity and network metadata to drive advanced attack detection.</p>');
    $("#row1_col5 .panel-title:contains('Stage 4')").attr('title', '<h3>Enrichment</h3><p>Augment security data with intelligence sources to better understand the context and impact of an event.</p>');
    $("#row1_col5 .panel-title:contains('Stage 5')").attr('title', '<h3>Automation and Orchestration</h3><p>Establish a consistent and repeatable security operation capability.</p>');
    $("#row1_col5 .panel-title:contains('Stage 6')").attr('title', '<h3>Advanced Detection</h3><p>Apply sophisticated detection mechanisms including machine learning.</p>');
    $("#row1_col6 .panel-title:contains('Stage 1')").attr('title', '<h3>Collection</h3><p>Collect basic security logs and other machine data from your environment.</p>');
    $("#row1_col6 .panel-title:contains('Stage 2')").attr('title', '<h3>Normalization</h3><p>Apply a standard security taxonomy and add asset and identity data.</p>');
    $("#row1_col6 .panel-title:contains('Stage 3')").attr('title', '<h3>Expansion</h3><p>Collect additional high fidelity data sources like endpoint activity and network metadata to drive advanced attack detection.</p>');
    $("#row1_col6 .panel-title:contains('Stage 4')").attr('title', '<h3>Enrichment</h3><p>Augment security data with intelligence sources to better understand the context and impact of an event.</p>');
    $("#row1_col6 .panel-title:contains('Stage 5')").attr('title', '<h3>Automation and Orchestration</h3><p>Establish a consistent and repeatable security operation capability.</p>');
    $("#row1_col6 .panel-title:contains('Stage 6')").attr('title', '<h3>Advanced Detection</h3><p>Apply sophisticated detection mechanisms including machine learning.</p>');
    $("#row1_col5 .panel-title[title]").tooltip({
      html: true,
      animation: true
    });
    $("#row1_col6 .panel-title[title]").tooltip({
      html: true,
      animation: true
    });
    ...
    $("[data-toggle=tab]").click(function (evt) {
      ...
      try {
        var _context;
        name = (0, _find["default"])(_context = $(obj).closest(".panel-body")).call(_context, "h1").text().replace(/^\d\. /, "");
      } catch (_unused) {
        // nothing
      }
      var status = true;
      var value = $(obj).text();
      var page = mvc.Components.getInstance("env").toJSON()['page'];
    ...
    //MITRE Matrix only works with v8 or higher. This is due to the eval mvmap command. 
    if ((0, _parseInt2["default"])(localStorage["splunk-major-version"]) < 8) {
      $("#mitremaptable h3").append(" <span style='font-style:italic;font-weight:normal' class='red'>" + "Nested Sub-Techniques visualization requires Splunk 8 or higher" + "</span>");
    }
  }).apply(null, __WEBPACK_AMD_REQUIRE_ARRAY__);}).catch(__webpack_require__.oe);
});
...
require(['jquery', 'splunkjs/mvc', 'bootstrap.tab', 'splunkjs/mvc/simplexml/ready!'], function ($, mvc) {
  /**
  ...
  var hideTabTargets = function hideTabTargets(tabSetClass) {
...
function hexToRgb(hex) {
  ...
  if (result) {
    ...
    var r = (0, _parseInt2["default"])(result[1], 16),
      g = (0, _parseInt2["default"])(result[2], 16),
      b = (0, _parseInt2["default"])(result[3], 16);
    return (0, _concat["default"])(_context2 = (0, _concat["default"])(_context3 = "".concat(r, ",")).call(_context3, g, ",")).call(_context2, b);
  }
  return null;
}
require(['splunkjs/mvc/searchmanager', 'splunkjs/mvc/simplexml/ready!'], function (SearchManager) {
  var searchstr = "| savedsearch \"Generate MITRE Environment Count\"";
  new SearchManager({
    id: "mitre_environment_count",
    search: searchstr
  });
});
