...
CONTENT_TYPES = ["YammerGroupsActivityDetail", "YammerGroupsActivityGroupCounts"]
...
class YammerInputRestHandler(AdminExternalHandler):
...
if __name__ == "__main__":
    ...
    admin_external.handle(
        endpoint,
        handler=YammerInputRestHandler,
    )
