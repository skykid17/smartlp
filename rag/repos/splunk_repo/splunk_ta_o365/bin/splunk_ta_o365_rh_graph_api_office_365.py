...
from rh_common import GraphAPIStartDateValidator
...
CONTENT_TYPES = ["Office365GroupsActivityDetail", "Office365ServicesUserCounts"]
...
class Office365InputRestHandler(AdminExternalHandler):
...
if __name__ == "__main__":
    ...
    admin_external.handle(
        endpoint,
        handler=Office365InputRestHandler,
    )
