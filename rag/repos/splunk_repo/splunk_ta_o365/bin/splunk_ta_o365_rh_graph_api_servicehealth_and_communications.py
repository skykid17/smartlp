...
CONTENT_TYPES = ["serviceAnnouncement.issues", "serviceAnnouncement.messages"]
...
class ServiceHealthAndCommunicationsInputRestHandler(AdminExternalHandler):
...
if __name__ == "__main__":
    ...
    admin_external.handle(
        endpoint,
        handler=ServiceHealthAndCommunicationsInputRestHandler,
    )
