...
CONTENT_TYPES = ["SharePointSiteUsageDetail", "SharePointSiteUsageFileCounts"]
...
class SharepointInputRestHandler(AdminExternalHandler):
...
if __name__ == "__main__":
    ...
    admin_external.handle(
        endpoint,
        handler=SharepointInputRestHandler,
    )
