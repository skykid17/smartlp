function return_page() {
    return '<div class="formWrapper">\
                <div class="fieldsetWrapper">\
                    <form action="https://splunkbase.splunk.com/app/3862/" method="get">\
                    <div style="font-size:14px;height=120px;border-radius:5px;background-color:#dbe9f0";margin:10px 20px;padding:10px 20px;>\
                        <p style="padding:15px"><span class="float-left">&#9432 Splunk Connector for Kafka has been released, and is now the officially supported way to ingest Kafka events.</span>\
                        <button type="submit" class="float-right credBtn">Get it now</button>\
                        </p>\
                    </div>\
                    </form>\
                </div>\
                ...
                <div style="border-radius:5px;border:1px solid red;">\
                <div class="fieldsetWrapper" style="color:red;padding:15px;"><span class="float-left" style="font-size:14px;">&#x26a0 Event collection within this add-on has been deprecated.</span>\
                </div>\
                ...
                <div class="fieldsetWrapper" id="credSettingId">\
                    <fieldset>\
                        ...
                        <div>\
                            ...
                            <button id="btnAdd" class="float-right credBtn"><span>Add Kafka Cluster</span></button>\
                        </div>\
                        <br>\
                        <br>\
                        <div>\
