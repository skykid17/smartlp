...
# Logging
#
# Defining rotating file handler
log = setupLogger(logger=getLogger("vmware_python3_suds"),
                  log_format='%(asctime)s %(levelname)s | pid:%(process)d | %(filename)s:%(funcName)s:%(lineno)d | [suds] %(message)s', log_name="vmware_python3_suds.log",
                  max_bytes=5000000)
