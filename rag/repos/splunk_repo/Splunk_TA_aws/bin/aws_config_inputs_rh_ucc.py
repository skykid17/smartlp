...
fields = [
    ...
    field.RestField(
        "sqs_queue", required=False, encrypted=False, default=None, validator=None
    ),
    field.RestField(
    ...
    field.RestField(
        "interval", required=False, encrypted=False, default=None, validator=None
    ),
    field.RestField(
        "sourcetype",
        required=False,
