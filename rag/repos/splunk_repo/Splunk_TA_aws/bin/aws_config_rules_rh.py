...
class ConfigRules(admin.MConfigHandler):
    ...
    def setup(self):
        """Setup method for config rules RH file."""
    ...
    def _list_rules(self, conf_info):
        ...
        factory = AWSCredentialsProviderFactory(config, region_name)
        ...
        while 1:
            try:
                ...
                logger.error(msg)
                raise RestError(
                    400, "Failed to describe config rules: " + msg
...
def main():
    """main method for config rules RH."""
