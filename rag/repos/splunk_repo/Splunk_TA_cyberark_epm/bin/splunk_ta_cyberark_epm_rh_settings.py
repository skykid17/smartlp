...
"""
rest handler file for proxy and logging settings for the add-on
"""
...
from splunk_ta_cyberark_epm_proxy_validation import ProxyValidator
...
from constants import CONFIGURATION_ERROR, UCC_EXECPTION_EXE_LABEL
...
class SettingsHandler(AdminExternalHandler):
    ...
    def __init__(self, *args, **kwargs):
        log_filename = "splunk_ta_cyberark_epm_settings"
    ...
    def is_ipv6(self, ipv6_address):
        try:
            ...
            add_ucc_error_logger(
                ...
                CONFIGURATION_ERROR,
                err,
                msg_before=f"Not a valid IPv6 address: {ipv6_address}.",
            )
            return False
